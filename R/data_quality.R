...
#' 
#' This funciton gives the local quality metric of spatiotemporal data points.
...
#' which quantifies the uncertainty of user whereabout caused by the intrinsic
#' limitation of measurement method (eg location coverage). The DYNAMIC part
#' gives the quanlity from dynamic information like speed, which emploies the
...
#'  will be set forcely to this quality (default 1e-5)
#' @param na the replacement of NA (default dq.min)
#' @return the origianl sessions with extra fields: c('dq.s', 'dq.d', 'dq'). `dq.s`
...
#' Spatiotemporal data quality of stay points
#' 
#' This is the inner implementaion of \code{\link{dq.point}}. Differently,
#' this function accepts the session data generated by \code{\link{gen.sessions}},
#' or external utilities.
#' 
#' @param sessions a data.frame of session data generated by \code{\link{gen.sesions}}
...
#' @return entropy the informatic entropy of point data qualities
